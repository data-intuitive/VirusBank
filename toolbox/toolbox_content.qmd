...
<h2 id="cell_section">Cell-based assays</h2>
...
<h2 id="hts_section">High-throughput screening (HTS)</h2>
<div class="container grid">
<div class="g-col-2 toolbox" style="text-align:center;">
<div class="tool-container">
<div class="tool-wrapper">
...
<h2 id="recombinant_section">Recombinant viruses</h2>
<div class="container grid">
<div class="g-col-2 toolbox" style="text-align:center;">
<div class="tool-container">
<div class="tool-wrapper">
...
<div class="col-xs-12" style="height:30px;"></div>
<script>tool_table("recombinant")</script>
</div>
<div class="g-col-1" style="text-align:center;">
</div>
</div>
...
<h2 id="ex-vivo_section">Ex-vivo models</h2>
<div class="container grid">
<div class="g-col-2 toolbox" style="text-align:center;">
<div class="tool-container">
<div class="tool-wrapper">
...
<div class="col-xs-12" style="height:30px;"></div>
<script>tool_table("ex-vivo")</script>
</div>
<div class="g-col-1" style="text-align:center;">
</div>
</div>
...
<h2 id="animal_section">Animal infection models</h2>
<div class="container grid">
<div class="g-col-2 toolbox" style="text-align:center;">
<div class="tool-container">
<div class="tool-wrapper">
...
<div class="col-xs-12" style="height:30px;"></div>
<script>tool_table("animal")</script>
</div>
<div class="g-col-1" style="text-align:center;">
</div>
</div>
...
<h2 id="target_section">Target-based assays</h2>
<div class="container grid">
<div class="g-col-2 toolbox" style="text-align:center;">
<div class="tool-container">
<div class="tool-wrapper">
...
<div class="col-xs-12" style="height:30px;"></div>
<script>tool_table("target")</script>
</div>
<div class="g-col-1" style="text-align:center;">
</div>
</div>
