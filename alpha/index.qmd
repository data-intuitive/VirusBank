  ...
  <div class="grid" style="--bs-gap: 0;">
    ...
    <div id="annotation-container" class="g-col-md-3 g-col-sm-12 no-gutter">
      <div class="container grid small" align="center" style="--bs-gap: 1.0rem;font-weight:500;">
          ...
          <div class="g-col-6 border card bg-tool card-body tool" id="cpe">CPE reduction assay</div>
          ...
          <div class="g-col-6 border card bg-tool card-body tool" id="plaque">Plaque assay</div>
