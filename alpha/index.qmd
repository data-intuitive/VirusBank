...
nwk = await FileAttachment("togaviridae.newick").text()
...
translation = ({
  "L01442_VEEV IAB": "VEEV",
  "AF375051_VEEV IC": "Also VEEV ?",
  "L00930_VEEV ID": "VEEV as well ?!"
})
...
rt = renderedTree
  .style_nodes(function(element, data) {
    ...
    element.on('mouseover', function() {
      ...
      d3.select('#mouseover-text').text(translation[data.data.name]);
    })
  })
  .layout(true)
  .show()
